...
5. **Integration Examples** (`jetbot_world_model_example.py`, `toroidal_dot_world_model_example.py`) - Shows how to connect world model with different robots/environments
